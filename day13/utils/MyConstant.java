package mobilerecharge.meenakshi.utils;
...
public class MyConstant {
    ...
    public static final String PLAN_ADD="/addplan";
    public static final String PLAN_GET="/allplan";
    public static final String ADDON = "/api/v1/addon";
    public static final String ADDON_UPDATE = "/update_addon";
    ...
    public static final String SWAGGER_INFO_CONTACT_NAME ="Meenakshi";
    public static final String SWAGGER_INFO_CONTACT_EMAIL ="727721eucs070@skcet.ac.in";
